...
public class ConquerAction extends Action {
	...
	public ConquerAction(Player actor, Unit attacker, Building defender) {
		super(actor);
	...
	protected void print() {
		System.err.printf("Player %s commanded unit #%d to conquer building #%d\n",
